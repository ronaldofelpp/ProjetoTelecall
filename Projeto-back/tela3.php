        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="2FA.html">Two factory authentication</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href="NúmMás.html">Número máscara</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href="GoogleVC.html">Google verified calls</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href="SMSProg.html">SMS programável</a></li>
            </ul>
          </li>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
            <a href="2FA.html" class="btn btn-primary">Saiba mais</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
            <a href="NúmMás.html" class="btn btn-primary">Saiba mais</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="text-center">
            <a href="GoogleVC.html" class="btn btn-primary">Saiba mais</a>
          </div>
        </div>
      </div>
    </div>
